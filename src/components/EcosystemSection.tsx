    ...
    <section className="bg-[hsla(74,100%,97%,1)]">
      <div className="max-w-330 mx-auto px-20">
        <div className="relative">
          ...
          <div className="absolute bottom-4 -right-10 rounded-3xl border-2 border-[#DDD] bg-white shadow-[4px_40px_8px_0_rgba(0,0,0,0.08)] px-12.5 py-20">
            ...
            <ul className="mt-10 space-y-4">
              {[
                ...
                <li key={item} className="flex items-center gap-3">
                  <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[hsla(76,97%,36%,1)]">
